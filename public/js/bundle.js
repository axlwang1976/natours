...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(cred) {
    var res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post('http://localhost:8080/api/users/login', cred);

          case 3:
            res = _context.sent;

            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Logged in suuccessfully!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.get('http://localhost:8080/api/users/logout');
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Shmething went wrong. Try again.');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXhsd2FuZzE5NzYiLCJhIjoiY2s3bXgyczA3MG1yNjNtbzN5emhsZXBvNiJ9.YPSvp997dLJUn92340bU_g';
...
},{}],"updateAccount.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.patch("http://localhost:8080/api/users/".concat(type), data);

          case 3:
            res = _context.sent;

            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'User setting updated.');
...
var stripe = Stripe('pk_test_fLShGAvyz6OlHZjtpo2UpwzO00CHiIKGjg');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("http://localhost:8080/api/bookings/checkout-session/".concat(tourId));
...
var bookingBtn = document.querySelector('#book-tour');
...
if (settingForm) {
  ...
  settingForm.addEventListener('submit', function (e) {
    ...
    form.append('email', _email.value);
    form.append('photo', photo.files[0]);
    (0, _updateAccount.updateSetting)(form, 'updateMe');
  });
}

if (passwordForm) {
  var oldPassword = document.querySelector('#password-current');
  var newPassword = document.querySelector('#password');
  var newPasswordConfirm = document.querySelector('#password-confirm');
  var passwords = {
    oldPassword: '',
    newPassword: '',
    newPasswordConfirm: ''
  ...
  oldPassword.addEventListener('change', function (e) {
    return passwords.oldPassword = e.target.value;
  });
  newPassword.addEventListener('change', function (e) {
    return passwords.newPassword = e.target.value;
  });
  newPasswordConfirm.addEventListener('change', function (e) {
    return passwords.newPasswordConfirm = e.target.value;
  });
  passwordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _updateAccount.updateSetting)(passwords, 'updatePassword');
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return (0, _booking.bookTour)(e.target.dataset.id);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1158" + '/');
